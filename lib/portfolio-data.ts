...
export const cases = [
  ...
  },
  {
    ...
    ownership:
      'Built an end-to-end data automation platform and led a team of 7 data engineers, with remote colleagues in Mexico and India. Standardized pipelines, transformations and recurring processes across petabyte-scale data. Built reusable feature pipelines, model discovery and data-quality controls, then established a shared MLOps and CI/CD foundation.',
    decisions: [
