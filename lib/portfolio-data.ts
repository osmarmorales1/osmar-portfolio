...
export const profile = {
  ...
  approach:
    'I create systems and processes that automate work and scale business capability. I combine hands-on AI engineering with workforce leadership, turning agents, reusable skills, shared knowledge and distributed compute into faster delivery and stronger teams.',
  adoption: {
    users: '500+',
