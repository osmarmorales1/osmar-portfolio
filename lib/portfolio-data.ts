...
export const cases = [
  ...
  },
  {
    ...
    ownership:
      'Use Elygent, the company I founded, as an independent AI lab to test emerging ideas and deepen hands-on expertise. Built a human–agent communication system and AI orchestration platform on open-source foundations, connecting conversations to accountable work. LLM-agnostic and harness-agnostic integrations through APIs, CLIs and MCP let teams reuse tools, skills and knowledge across workflows. AI governance and cybersecurity include scoped access, security monitoring, isolated execution and human review.',
    decisions: [
