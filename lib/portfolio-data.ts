...
export const profile = {
  ...
  thesis: 'I bring teams to the AI frontier.',
  approach:
    'I stay close to what is changing in AI, evaluate what is useful, and turn it into shared platforms so colleagues can focus on their work.',
  adoption: {
    users: '500+',
...
export const cases = [
  {
    ...
    metric: '500+',
    unit: 'users · organic adoption',
    summary: 'A platform that makes AI capability accessible across the team.',
    problem:
      'New models and tools arrive faster than people can learn them. Individual experiments need a path into repeatable work.',
    ownership:
      'I architect and operate the platform around an existing agent engine, connecting governed tools, reusable skills, knowledge, model routing, and human review. My delivery work spans self-service private-cloud compute, storage and network services.',
    decisions: [
      'Package new capabilities behind a familiar experience.',
      'Keep identity, budgets, and approvals at the platform boundary.',
      'Use independent validation and feedback to improve delivery.',
    ],
    outcome:
      '500+ users, with organic growth. Container, macOS desktop, and private-cloud delivery support different ways of working.',
    tags: [
      'Private cloud',
      'Kubernetes / Docker',
      'MCP / APIs',
    ...
    note: 'Adoption confirmed September 2026. No daily-active or concurrent-user claim.',
  ...
  },
  {
    id: 'elygent',
    label: 'Elygent',
    kind: 'INDEPENDENT · DEVELOPMENT PILOT',
    title: 'One capability layer.\nA shared advantage.',
    metric: 'One',
    unit: 'connected team experience',
    summary: 'An AI platform for agentic team collaboration.',
    problem:
    ...
    ownership:
      'I am building the integration and governance layer around established runtimes: identity-scoped MCP access, curated knowledge, accountable execution, and recovery.',
    decisions: [
      'Choose the right runtime for the work.',
      'Preserve person and business boundaries across surfaces.',
      'Prove the real model-to-tool path, then keep the reusable lesson.',
    ],
    outcome:
      'Built an independent platform for people and AI agents to collaborate through connected tools, shared knowledge, accountable work, and recovery. The public portfolio sandbox demonstrates two specialists working in parallel and handing evidence to an editor.',
    tags: [
      'MCP / APIs',
      'Linux / Docker',
      'PostgreSQL / Redis',
    ...
    note: 'Independent development pilot; separate from Visa and its adoption metrics.',
