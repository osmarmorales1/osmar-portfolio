...
export const profile = {
  ...
  approach:
    'I build the systems that make teams more capable: global-scale data automation, agent platforms and self-hosted AI. I turn complex work into reusable workflows and intuitive tools that help people deliver more with the resources they have.',
  adoption: {
    users: '500+',
...
export const cases = [
  {
    ...
    tags: [
      ...
      'Reusable skills / continuous learning',
  ...
  {
    id: 'elygent',
    label: 'Independent AI lab',
    kind: 'INDEPENDENT AI RESEARCH · ELYGENT',
    title: 'Explore the frontier.\nBuild what I learn.',
    metric: 'AI lab',
    unit: 'hands-on experimentation',
    summary:
      'Hands-on experiments that deepen my AI engineering skills, built through Elygent, the company I founded.',
    problem:
    ...
    ownership:
      'Use Elygent, the company I founded, as an independent AI lab to test emerging ideas and deepen hands-on expertise. Built a human–agent communication system and AI orchestration platform on open-source foundations, connecting conversations to accountable work. LLM-agnostic and harness-agnostic integrations through APIs, CLIs and MCP let teams reuse tools, skills and knowledge across workflows. Hands-on model work includes self-hosted open models on shared compute. AI governance and cybersecurity include scoped access, security monitoring, isolated execution and human review.',
    decisions: [
    ...
    outcome:
      'Turned research into working experiments: a public cloud-agent lab on Linux VPS, Agentic Slack collaboration and controlled browser execution. Visitors can delegate research, follow specialist handoffs and review the results.',
    tags: [
      'MCP / APIs',
      'Linux / Docker',
